	...
	$custom_settings = array(
		...
		'settings'        => array(
			...
			array(
				...
				'desc'         => sprintf( __( 'The Colorpicker Opacity option type saves an rgba color value for use in CSS. To add opacity to other colorpickers add the %1$s class to the %2$s array.', 'prince' ), '<code>prince-colorpicker-opacity</code>', '<code>$args</code>' ),
				'std'          => '',
