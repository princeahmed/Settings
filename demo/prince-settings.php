	...
	$custom_settings = array(
		...
		'sections'        => array(
			array(
				...
				'title' => __( 'Top Header Menus', 'wp-radio' )
			),
			array(
				'id'    => 'site_info',
				'title' => __( 'Site Info', 'wp-radio' )
			),
			array(
				'id'    => 'header',
				'title' => __( 'Hero Section', 'wp-radio' )
			),
			array(
				'id'    => 'services',
				'title' => __( 'Services Section', 'wp-radio' )
			),
			array(
				'id'    => 'expertise',
				'title' => __( 'Expertise Section', 'wp-radio' )
			),
			array(
				'id'    => 'skills',
				'title' => __( 'Skills Section', 'wp-radio' )
			),

			array(
				'id'    => 'portfolios',
				'title' => __( 'Portfolios Section', 'wp-radio' )
			),
			array(
				'id'    => 'testimonals',
				'title' => __( 'Testimonials Section', 'wp-radio' )
			),

			array(
				'id'    => 'call_to_action',
				'title' => __( 'Call To Action Section', 'wp-radio' )
			),
			array(
				'id'    => 'about',
				'title' => __( 'About Page', 'wp-radio' )
			),
