...
if ( ! function_exists( 'prince_display_by_type' ) ) {
	...
	function prince_display_by_type( $args = array() ) {
		...
		if ( function_exists( $function_name_by_type ) ) {
			...
			echo '<p>' . __( 'Sorry, this function does not exist', 'prince-text-domain' ) . '</p>';
		}
...
if ( ! function_exists( 'prince_type_category_checkbox' ) ) {
	...
	function prince_type_category_checkbox( $args = array() ) {
		...
		if ( ! empty( $categories ) ) {
			...
			echo '<p>' . __( 'No Categories Found', 'prince-text-domain' ) . '</p>';
		}
...
if ( ! function_exists( 'prince_type_category_select' ) ) {
	...
	function prince_type_category_select( $args = array() ) {
		...
		if ( ! empty( $categories ) ) {
			...
			echo '<option value="">' . __( 'No Categories Found', 'prince-text-domain' ) . '</option>';
		}
...
if ( ! function_exists( 'prince_type_custom_post_type_checkbox' ) ) {
	...
	function prince_type_custom_post_type_checkbox( $args = array() ) {
		...
		if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
			...
			echo '<p>' . __( 'No Posts Found', 'prince-text-domain' ) . '</p>';
		}
...
if ( ! function_exists( 'prince_type_custom_post_type_select' ) ) {
	...
	function prince_type_custom_post_type_select( $args = array() ) {
		...
		if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
			...
			echo '<option value="">' . __( 'No Posts Found', 'prince-text-domain' ) . '</option>';
		}
...
if ( ! function_exists( 'prince_type_link_color' ) ) {
	...
	function prince_type_link_color( $args = array() ) {
		...
		$prince_recognized_link_color_fields = apply_filters( 'prince_recognized_link_color_fields', array(
			...
			'visited' => _x( 'Visited', 'color picker', 'prince-text-domain' ),
			'focus'   => _x( 'Focus', 'color picker', 'prince-text-domain' )
		), $field_id );
...
if ( ! function_exists( 'prince_type_page_checkbox' ) ) {
	...
	function prince_type_page_checkbox( $args = array() ) {
		...
		if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
			...
			echo '<p>' . __( 'No Pages Found', 'prince-text-domain' ) . '</p>';
		}
...
if ( ! function_exists( 'prince_type_page_select' ) ) {
	...
	function prince_type_page_select( $args = array() ) {
		...
		if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
			...
			echo '<option value="">' . __( 'No Pages Found', 'prince-text-domain' ) . '</option>';
		}
...
if ( ! function_exists( 'prince_type_sidebar_select' ) ) {
	...
	function prince_type_sidebar_select( $args = array() ) {
		...
		/* has sidebars */
		if ( count( $sidebars ) ) {
			echo '<option value="">-- ' . __( 'Choose Sidebar', 'prince-text-domain' ) . ' --</option>';
			foreach ( $sidebars as $id => $sidebar ) {
				echo '<option value="' . esc_attr( $id ) . '"' . selected( $field_value, $id, false ) . '>' . esc_attr( $sidebar ) . '</option>';
			}
		} else {
			echo '<option value="">' . __( 'No Sidebars', 'prince-text-domain' ) . '</option>';
		}
	...
	function prince_type_social_links( $args = array() ) {
		...
		if ( empty( $field_value ) && apply_filters( 'prince_type_social_links_load_defaults', true, $field_id ) ) {
			...
			$field_value = apply_filters( 'prince_type_social_links_defaults', array(
				...
				array(
					'name'  => __( 'Twitter', 'prince-text-domain' ),
					'title' => '',
					'href'  => ''
				),
				array(
					'name'  => __( 'Google+', 'prince-text-domain' ),
					'title' => '',
					'href'  => ''
				),
				array(
					'name'  => __( 'LinkedIn', 'prince-text-domain' ),
					'title' => '',
					'href'  => ''
				),
				array(
					'name'  => __( 'Pinterest', 'prince-text-domain' ),
					'title' => '',
					'href'  => ''
				),
				array(
					'name'  => __( 'Youtube', 'prince-text-domain' ),
					'title' => '',
					'href'  => ''
				),
				array(
					'name'  => __( 'Dribbble', 'prince-text-domain' ),
					'title' => '',
					'href'  => ''
				),
				array(
					'name'  => __( 'Github', 'prince-text-domain' ),
					'title' => '',
					'href'  => ''
				),
				array(
					'name'  => __( 'Forrst', 'prince-text-domain' ),
					'title' => '',
					'href'  => ''
				),
				array(
					'name'  => __( 'Digg', 'prince-text-domain' ),
					'title' => '',
					'href'  => ''
				),
				array(
					'name'  => __( 'Delicious', 'prince-text-domain' ),
					'title' => '',
					'href'  => ''
				),
				array(
					'name'  => __( 'Tumblr', 'prince-text-domain' ),
					'title' => '',
					'href'  => ''
				),
				array(
					'name'  => __( 'Skype', 'prince-text-domain' ),
					'title' => '',
					'href'  => ''
				),
				array(
					'name'  => __( 'SoundCloud', 'prince-text-domain' ),
					'title' => '',
					'href'  => ''
				),
				array(
					'name'  => __( 'Vimeo', 'prince-text-domain' ),
					'title' => '',
					'href'  => ''
				),
				array(
					'name'  => __( 'Flickr', 'prince-text-domain' ),
					'title' => '',
					'href'  => ''
				),
				array(
					'name'  => __( 'VK.com', 'prince-text-domain' ),
					'title' => '',
					'href'  => ''
				)
			), $field_id );
...
if ( ! function_exists( 'prince_type_tag_checkbox' ) ) {
	...
	function prince_type_tag_checkbox( $args = array() ) {
		...
		if ( $tags ) {
			...
			echo '<p>' . __( 'No Tags Found', 'prince-text-domain' ) . '</p>';
		}
...
if ( ! function_exists( 'prince_type_tag_select' ) ) {
	...
	function prince_type_tag_select( $args = array() ) {
		...
		if ( $tags ) {
			...
			echo '<option value="">' . __( 'No Tags Found', 'prince-text-domain' ) . '</option>';
		}
...
if ( ! function_exists( 'prince_type_taxonomy_checkbox' ) ) {
	...
	function prince_type_taxonomy_checkbox( $args = array() ) {
		...
		if ( $taxonomies ) {
			...
			echo '<p>' . __( 'No Taxonomies Found', 'prince-text-domain' ) . '</p>';
		}
...
if ( ! function_exists( 'prince_type_taxonomy_select' ) ) {
	...
	function prince_type_taxonomy_select( $args = array() ) {
		...
		if ( $taxonomies ) {
			...
			echo '<option value="">' . __( 'No Taxonomies Found', 'prince-text-domain' ) . '</option>';
		}
